...
import com.upe.dce.core.gerarPdf.Customer;
import com.upe.dce.core.gerarPdf.IPdfGenerateService;
import com.upe.dce.core.gerarPdf.PdfGenerateServiceImpl;
import com.upe.dce.core.gerarPdf.QuoteItem;
...
public class PdfGeneratorRunner implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    pdfGenerateService.generatePdfFile("quotation", "quotation.pdf", data);
